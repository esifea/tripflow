  ...
  const locales = {
    en: {
      ...
      trip: {
        ...
        memo: 'Trip Memo',
        memoPlaceholder: 'Booking references, packing lists, general notes...',
        memoHasContent: 'has notes',
      ...
      historyModal: {
        ...
        details: {
          createdNewTrip: 'Created new trip',
          renamedTo: 'Renamed to "{name}"',
          setDestination: 'Set destination to {value}',
          clearedDestination: 'Cleared destination',
          setStartDate: 'Set start date to {value}',
          clearedStartDate: 'Cleared start date',
          setEndDate: 'Set end date to {value}',
          clearedEndDate: 'Cleared end date',
          updatedMemo: 'Updated memo',
          clearedMemo: 'Cleared memo',
          addedChecklistItem: 'Added checklist item: "{item}"',
          removedChecklistItem: 'Removed checklist item: "{item}"',
          editedChecklist: 'Edited checklist: "{from}" → "{to}"',
          updatedChecklist: 'Updated checklist',
          addedEvent: 'Added event: {name}',
          updatedEvent: 'Updated event: {name}',
          deletedEvent: 'Deleted event ID: {id}',
          swappedDays: 'Swapped schedule: Day {a} ↔ Day {b}',
          updatedTripMetadata: 'Updated trip metadata',
        },
      },
      toast: {
    ...
    ko: {
      ...
      trip: {
        ...
        checklist: '체크리스트',
        checklistPlaceholder: '항목 추가...',
        checklistCount: '{done}/{total}',
        memo: '여행 메모',
        memoPlaceholder: '예약 정보, 준비물, 메모 등...',
        memoHasContent: '메모 있음',
      ...
      historyModal: {
        ...
        details: {
          createdNewTrip: '새 여행 생성',
          renamedTo: '"{name}"(으)로 이름 변경',
          setDestination: '목적지를 {value}(으)로 설정',
          clearedDestination: '목적지 삭제',
          setStartDate: '시작일을 {value}(으)로 설정',
          clearedStartDate: '시작일 삭제',
          setEndDate: '종료일을 {value}(으)로 설정',
          clearedEndDate: '종료일 삭제',
          updatedMemo: '메모 수정',
          clearedMemo: '메모 삭제',
          addedChecklistItem: '체크리스트 항목 추가: "{item}"',
          removedChecklistItem: '체크리스트 항목 삭제: "{item}"',
          editedChecklist: '체크리스트 수정: "{from}" → "{to}"',
          updatedChecklist: '체크리스트 수정',
          addedEvent: '일정 추가: {name}',
          updatedEvent: '일정 수정: {name}',
          deletedEvent: '일정 삭제 ID: {id}',
          swappedDays: '일정 교환: {a}일차 ↔ {b}일차',
          updatedTripMetadata: '여행 정보 수정',
        },
      },
      toast: {
